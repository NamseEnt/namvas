...
export function AdminOrdersPage({ status, search, page }: AdminOrdersPageProps) {
...
function StatusFilters({
  ...
  const filters = [
    ...
    { value: "payment_pending", label: "결제대기", count: undefined },
    { value: "payment_completed", label: "결제완료", count: undefined },
    { value: "payment_failed", label: "결제실패", count: undefined },
