import { ParsedSchema, MigrationStep, DocumentDefinition, FieldType } from './schema-types.js';

export function generateMigrations(schema: ParsedSchema): string {
...
`;
  ...
  for (const [docName, docDef] of schema.documents) {
    output += generateDocumentMigration(docName, docDef, schema.migrations);
    output += '\n\n';
  }
