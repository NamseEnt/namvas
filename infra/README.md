...
A minimal Pulumi template for provisioning AWS infra using TypeScript. This template creates an Amazon S3 bucket and exports its name.
...
2.  Preview and deploy your infra:
